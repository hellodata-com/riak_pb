...
dfp_read_field_def_rpbcontent(<<>>, 0, 0, F1, F2, F3,
    ...
    #rpbcontent{value = F1, content_type = F2, charset = F3,
		...
		indexes = lists_reverse(F10, TrUserData),
		deleted = F11};
...
d_field_rpbcontent_indexes(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_rpbcontent(Rest2, 0, 0, F1, F2, F3,
				  F4, F5, F6, F7, F8, F9,
				  cons(NewFValue, F10, TrUserData), F11,
				  TrUserData).
...
merge_msg_rpbcoverageentry(#rpbcoverageentry{ip = PFip,
					     port = PFport,
					     keyspace_desc = PFkeyspace_desc,
...
get_msg_names() ->
    [rpbmodfun, rpbbucketkeypreflistitem, rpblink,
     rpbcommithook, rpbcoverageentry, rpbpair, rpbcontent,
     rpbgetresp, rpbindexobject, rpbbucketprops,
     rpbresetbucketreq, rpbcsbucketreq, rpbsetclientidreq,
     rpbindexreq, rpbsetbuckettypereq, rpbgetbuckettypereq,
     rpbdelreq, rpbputreq, rpbgetreq, rpbcoveragereq,
     rpbcountergetreq, rpblistkeysreq, rpbcounterupdatereq,
     rpblistbucketsreq, rpbauthreq, rpbmapredreq,
     rpbgetbucketkeypreflistreq, rpbsetbucketreq,
     rpbgetbucketreq, rpbindexresp, rpblistkeysresp,
     rpbcounterupdateresp, rpbgetbucketkeypreflistresp,
     rpblistbucketsresp, rpbgetserverinforesp,
     rpbcsbucketresp, rpbmapredresp, rpbgetbucketresp,
     rpbcountergetresp, rpbindexbodyresp, rpbcoverageresp,
     rpbputresp, rpbgetclientidresp, rpberrorresp].
